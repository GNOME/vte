...
try
{
        ...
        case 4: { // progress
                ...
                case 0: // reset
                        maybe_reset_termprop(VTE_PROPERTY_ID_PROGRESS_STATE);
                        maybe_reset_termprop(VTE_PROPERTY_ID_PROGRESS_VALUE);
                        return;

                case 1: // running
                        maybe_set_termprop(VTE_PROPERTY_ID_PROGRESS_STATE, uint64_t(VTE_PROGRESS_ACTIVE));
                        maybe_set_termprop(VTE_PROPERTY_ID_PROGRESS_VALUE, uint64_t(pr));
                        return;

                case 2: // error
                        maybe_set_termprop(VTE_PROPERTY_ID_PROGRESS_STATE, uint64_t(VTE_PROGRESS_ERROR));
                        maybe_set_termprop(VTE_PROPERTY_ID_PROGRESS_VALUE, uint64_t(pr));
                        return;
                ...
                case 4: // paused
                        maybe_set_termprop(VTE_PROPERTY_ID_PROGRESS_STATE, uint64_t(VTE_PROGRESS_PAUSED));
                        maybe_set_termprop(VTE_PROPERTY_ID_PROGRESS_VALUE, uint64_t(pr));
                        return;
