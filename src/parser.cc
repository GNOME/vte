...
uint32_t
Parser::parse_charset_94(uint32_t raw, unsigned int intermediates) noexcept
{
...
uint32_t
Parser::parse_charset_94_n(uint32_t raw, unsigned int intermediates) noexcept
{
        assert (raw >= 0x30 && raw < 0x7f);
...
uint32_t
Parser::parse_charset_96(uint32_t raw, unsigned int intermediates) noexcept
{
        assert (raw >= 0x30 && raw < 0x7f);
...
uint32_t
Parser::parse_charset_96_n(uint32_t raw, unsigned int intermediates) noexcept
{
...
uint32_t
Parser::parse_charset_ocs(uint32_t raw, unsigned int intermediates) noexcept
{
        assert (raw >= 0x30 && raw < 0x7f);
...
uint32_t
Parser::parse_charset_control(uint32_t raw, unsigned int intermediates) noexcept
{
        assert (raw >= 0x30 && raw < 0x7f);
...
uint32_t
Parser::parse_host_escape(vte_seq_t const* seq, unsigned int *cs_out) noexcept
{
